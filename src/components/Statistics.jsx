        ...
        <div className="glass-card grid gap-4 rounded-3xl p-5 sm:grid-cols-2 lg:grid-cols-4 lg:p-7">
          {stats.map((stat, i) => (
            <Reveal key={stat.label} delay={i * 90}>
              <div className="rounded-2xl border border-border/70 bg-[image:var(--gradient-soft)] p-5 text-center transition-all duration-500 hover:-translate-y-1 hover:border-accent/45 hover:shadow-[var(--shadow-glow)]">
