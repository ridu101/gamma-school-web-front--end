...
export default function StudentPortal() {
  ...
  const showResult = (event) => {
    ...
    if (!found) {
      setResult(null);
      setError(
        "এই রোল নম্বরের কোনো ডেমো তথ্য পাওয়া যায়নি। ১, ২ বা ৩ ব্যবহার করে দেখুন।"
      );
      return;
    }
  ...
  const fieldClass =
    "box-border w-full min-w-0 max-w-full rounded-2xl border border-cyan-soft/20 bg-navy-deep/60 px-4 py-3 text-sm text-cyan-soft outline-none transition-all duration-300 focus:border-accent/70 focus:shadow-[var(--shadow-glow)]";
      ...
      <div className="container-x relative min-w-0">
        ...
        <Reveal className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl break-words text-sm leading-relaxed text-cyan-soft/80 sm:text-base">
            পরীক্ষার ফলাফল অনুসন্ধান, শ্রেণি রুটিন, হাজিরা এবং শিক্ষার্থী
            সংক্রান্ত তথ্য এক জায়গায়।
          </p>
        ...
        {/* =========================
            MAIN PORTAL
        ========================== */}
        <Reveal delay={100} className="mt-10 min-w-0 sm:mt-12 lg:mt-16">
                  ...
                  <div className="relative mx-auto grid place-items-center">
                    ...
                    >
                      ...
                      <circle
                        ...
                        strokeDashoffset={
                          circumference * (1 - Number(rate) / 100)
                        }
                      />
                    </svg>
